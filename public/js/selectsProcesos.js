            ...
            var subselect = {
              "Definición y Clarificación de las Necesidades del Cliente": ['RFQ Recibido y Confirmado', 'Cotización Interna de Nuevos Proyectos', 'Realización del Estudio de Factibilidad', 
              'Conceptualización del Estudio de PCRS', 'Entrega de Cotización al Cliente','Aceptación de Cotización por Parte del Cliente','Definición de SE- TEAM y PL',
              'Creación y Administración del Presupuesto', 'Quality Gate 2'],
              "Conceptualización": ['Revisión Técnica Finalizada', 'Realización de Simulaciones CAX', 'Concepto de Logística y Empaque', 'Definición de Concepto Técnico ',
              'Selección de Proveedores para Nuevos Proyectos', 'Quality Gate 3'],
              ...
              "Producción y Soporte": ['Análisis de Rentabilidad del Producto', 'Aseguramiento de Calidad de Proveedores', 'Investigación y Desarrollo ', 'Revisión del Costo y Actualización de la Cotización'
              ,'Evaluación de Quality Gates', 'Quality Gate 6'],
              "Requerimientos y Selección de Proveedores": ['Requerimientos','Cotizaciones','Autorización de Solicitudes de Pedido','Selección y Alta de Proveedores','Trámites de Agentes Aduanales y/o Comercio Exterior',
              'Elaboración y Seguimiento al Presupuesto de Compra','Creación / Actualización de Datos Maestros de Compras', 'Mantenimiento de Precios', 'Definición de Estrategias', 
              'Actualización de Sistemas de Comercio Exterior', 'Reporte Programas de Fomento'],
              "Orden de Compra": ['Creación y Liberación de Documentos de Compra', 'Tránsito de Entrada Nacional e Importación','Proceso Maquila','Aviso de Opción para la Determinación del Seguro Global de Transporte',
              'Pedimentos Virtuales - Importación'],
              "Recepción de Bienes y Servicios": ['Recibo de Material y Servicios','Inspección Recibo y Laboratorio de Pruebas','Gestión de Materiales en Cuarentena','Evaluación de Desempeño de Proveedores',
              ...
              "Administración de personal": ['Movimientos de personal','Atención al personal','Incidencias','Puntualidad y Asistencia del Personal','Gestión del Clima Organizacional','Comunicación Organizacional','Salud ocupacional','Administración de Comedor'
